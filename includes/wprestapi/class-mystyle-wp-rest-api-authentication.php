<?php
/**
 * Provides authentication for the WordPress API. This is mostly copy/paste from
...
/**
 * MyStyle_Wp_Rest_Api_Authentication class.
 */
class MyStyle_Wp_Rest_Api_Authentication {
	...
	protected function is_request_to_rest_api() {
		...
		$woocommerce = ( false !== strpos( $_SERVER['REQUEST_URI'], $rest_prefix . 'mystyle/' ) ); // @codingStandardsIgnoreLine

		// Allow third party plugins use our authentication methods.
		$third_party = ( false !== strpos( $_SERVER['REQUEST_URI'], $rest_prefix . 'mystyle-' ) ); // @codingStandardsIgnoreLine
