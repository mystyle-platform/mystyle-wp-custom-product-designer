				...
				<ul class="statistics">
					<li>
						<div class="design-count">
							...
							<p>
								<?php if ( defined( 'MYSTYLE_DM_VERSION' ) ) : ?>
								<a href="<?php echo esc_url( admin_url( 'admin.php?page=mystyle_designs' ) ); ?>" title="View Design Manager">
				...
				<ul class="statistics">
					<li>
						<div class="design-count">
							...
							<p>
								<a href="<?php echo esc_url( admin_url( 'edit-tags.php?taxonomy=design_tag' ) ); ?>" title="View Design Manager">
					...
					<li>
						<div class="design-products">
							...
							<p>
								<a href="<?php echo esc_url( admin_url( 'edit-tags.php?taxonomy=design_collection' ) ); ?>" title="View Design Manager">
