<?php
/**
 * The MyStyleDesignCollectionShortcodeTest class includes tests for testing the
...
/**
 * MyStyleDesignCollectionShortcodeTest class.
 */
class MyStyleDesignCollectionShortcodeTest extends WP_UnitTestCase {
	...
	public function test_output() {
		...
		// Call the function.
		$output = MyStyle_Design_Collection_Shortcode::output( $atts );

		// Assert that the output contains the expected HTML code.
		$this->assertContains(
			'class="mystyle-design-collection-index',
			$output
		);
	}
